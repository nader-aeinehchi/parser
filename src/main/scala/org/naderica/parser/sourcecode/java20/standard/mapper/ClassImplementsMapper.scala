...
import org.naderica.parser.sourcecode.java20.standard.grammar.ClassImplements
import org.naderica.parser.sourcecode.java20.standard.grammar.InterfaceTypeList

object ClassImplementsMapper {
    def toClassImplements(ctx: ClassImplementsContext): ClassImplements = {
      // ClassImplementsContext typically has an interfaceTypeList
      ...
      ClassImplements(interfaceTypeList)
    }
  }